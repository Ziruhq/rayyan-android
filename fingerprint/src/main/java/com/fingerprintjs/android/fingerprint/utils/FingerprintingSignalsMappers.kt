...
public val FingerprintingSignal<*>.humanName: String
    get() = when (this) {
 ...
 */
public val FingerprintingSignal<*>.jsonifiableValue: Any
    get() = when (this) {
...
public val FingerprintingSignal<*>.humanValue: String
    get() = when (this) {
...
public interface Jsonifiable {
    public fun toJsonifiable(): Any
}

public data class CameraListSignalItemVo(
    ...
    override fun toJsonifiable(): Map<String, Any> = mapOf(
...
public data class CodecListSignalItemVo(
    @SerializedName("name") val name: String,
    @SerializedName("capabilities") val capabilities: List<String>
) : Jsonifiable {
    override fun toJsonifiable(): Map<String, Any> = mapOf(
        "name" to name,
        "capabilities" to capabilities // List is already JSON-compatible
    )
}

public data class InputDevicesSignalItemVo(
    @SerializedName("name") val name: String,
...
public data class SensorsSignalItemVo(
